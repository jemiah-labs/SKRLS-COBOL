...
public class MoveStatementImpl extends StatementImpl implements MoveStatement {
	...
	public MoveStatementImpl(final ProgramUnit programUnit, final Scope scope, final MoveStatementContext ctx, final Producer producer) {
	...
	public MoveCorrespondingToStatetement addMoveCorrespondingToStatement(
		...
		if (result == null) {
			result = new MoveCorrespondingToStatementImpl(programUnit, ctx, producer);
	...
	public MoveToStatement addMoveToStatement(final MoveToStatementContext ctx) {
		...
		if (result == null) {
			result = new MoveToStatementImpl(programUnit, ctx, producer);
