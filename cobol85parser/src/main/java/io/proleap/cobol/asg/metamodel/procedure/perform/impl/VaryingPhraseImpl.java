...
public class VaryingPhraseImpl extends CobolDivisionElementImpl implements VaryingPhrase {
	...
	public VaryingPhraseImpl(final ProgramUnit programUnit, final PerformVaryingPhraseContext ctx, final Producer producer) {
	...
	public ByPhrase addByPhrase(final PerformByContext ctx) {
		...
		if (result == null) {
			result = new ByPhraseImpl(programUnit, ctx, producer);
	...
	public FromPhrase addFromPhrase(final PerformFromContext ctx) {
		...
		if (result == null) {
			result = new FromPhraseImpl(programUnit, ctx, producer);
