...
public class SendingsImpl extends CobolDivisionElementImpl implements Sendings {
	...
	public SendingsImpl(final ProgramUnit programUnit, final StringSendingPhraseContext ctx, final Producer producer) {
	...
	public ForPhrase addForPhrase(final StringForPhraseContext ctx) {
		...
		if (result == null) {
			result = new ForPhraseImpl(programUnit, ctx, producer);
