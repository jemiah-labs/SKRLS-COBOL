...
public class SendStatementImpl extends StatementImpl implements SendStatement {
	...
	public SendStatementImpl(final ProgramUnit programUnit, final Scope scope, final SendStatementContext ctx, final Producer producer) {
	...
	public Async addAsync(final SendStatementAsyncContext ctx) {
		...
		if (result == null) {
			result = new AsyncImpl(programUnit, ctx, producer);
	...
	public Sync addSync(final SendStatementSyncContext ctx) {
		...
		if (result == null) {
			result = new SyncImpl(programUnit, ctx, producer);
