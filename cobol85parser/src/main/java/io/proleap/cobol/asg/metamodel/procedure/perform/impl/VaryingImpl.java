...
public class VaryingImpl extends CobolDivisionElementImpl implements Varying {
	...
	public VaryingImpl(final ProgramUnit programUnit, final PerformVaryingContext ctx, final Producer producer) {
	...
	public VaryingClause addVaryingClause(final PerformVaryingClauseContext ctx) {
		...
		if (result == null) {
			result = new VaryingClauseImpl(programUnit, ctx, producer);
