...
public class UnstringStatementImpl extends StatementImpl implements UnstringStatement {
	...
	public UnstringStatementImpl(final ProgramUnit programUnit, final Scope scope, final UnstringStatementContext ctx, final Producer producer) {
	...
	public IntoPhrase addIntoPhrase(final UnstringIntoPhraseContext ctx) {
		...
		if (result == null) {
			result = new IntoPhraseImpl(programUnit, ctx, producer);
	...
	public Sending addSending(final UnstringSendingPhraseContext ctx) {
		...
		if (result == null) {
			result = new SendingImpl(programUnit, ctx, producer);
	...
	public TallyingPhrase addTallyingPhrase(final UnstringTallyingPhraseContext ctx) {
		...
		if (result == null) {
			result = new TallyingPhraseImpl(programUnit, ctx, producer);
	...
	public WithPointerPhrase addWithPointerPhrase(final UnstringWithPointerPhraseContext ctx) {
		...
		if (result == null) {
			result = new WithPointerPhraseImpl(programUnit, ctx, producer);
