...
public class EvaluateStatementImpl extends StatementImpl implements EvaluateStatement {
	...
	public EvaluateStatementImpl(final ProgramUnit programUnit, final Scope scope, final EvaluateStatementContext ctx, final Producer producer) {
	...
	public AlsoSelect addAlsoSelect(final EvaluateAlsoSelectContext ctx) {
		...
		if (result == null) {
			result = new AlsoSelectImpl(programUnit, ctx, producer);
	...
	public WhenOther addWhenOther(final EvaluateWhenOtherContext ctx) {
		...
		if (result == null) {
			result = new WhenOtherImpl(programUnit, ctx, producer);
	...
	public WhenPhrase addWhenPhrase(final EvaluateWhenPhraseContext ctx) {
		...
		if (result == null) {
			result = new WhenPhraseImpl(programUnit, ctx, producer);
	...
	protected Select createSelect(final EvaluateSelectContext ctx) {
		...
		if (result == null) {
			result = new SelectImpl(programUnit, ctx, producer);
