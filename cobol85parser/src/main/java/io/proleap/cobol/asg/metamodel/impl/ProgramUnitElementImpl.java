...
public class ProgramUnitElementImpl extends CompilationUnitElementImpl implements ProgramUnitElement {
	...
	public ProgramUnitElementImpl(final ProgramUnit programUnit, final ParserRuleContext ctx, final Producer producer) {
	...
	protected ArithmeticValueStmt createArithmeticValueStmt(final ArithmeticExpressionContext ctx) {
		...
		if (result == null) {
			result = new ArithmeticValueStmtImpl(programUnit, ctx, producer);
	...
	protected BooleanLiteral createBooleanLiteral(final BooleanLiteralContext ctx) {
		...
		if (result == null) {
			...
			result = new BooleanLiteralImpl(value, programUnit, ctx, producer);
	...
	protected BooleanLiteralValueStmt createBooleanLiteralValueStmt(final BooleanLiteralContext ctx) {
		...
		final BooleanLiteralValueStmt result = new BooleanLiteralValueStmtImpl(programUnit, ctx, producer);
	...
	protected Call createCall(final CdNameContext ctx) {
		...
		if (result == null) {
			...
			if (communicationDescriptionEntry == null) {
				producer.emitWarningMessage("call to unknown communication description element " + name);
				result = createUndefinedCall(ctx);
			} else {
	...
	protected Call createCall(final EnvironmentNameContext ctx) {
		...
		if (result == null) {
			final String name = determineName(ctx);
			result = new EnvironmentCallImpl(name, programUnit, ctx, producer);
	...
	protected Call createCall(final FunctionCallContext ctx) {
		...
		if (result == null) {
			final String name = determineName(ctx);
			final FunctionCall functionCall = new FunctionCallImpl(name, programUnit, ctx, producer);
	...
	protected Call createCall(final IdentifierContext ctx) {
		...
		if (ctx.qualifiedDataName() != null) {
			...
			result = new CallDelegateImpl(dataCall, programUnit, ctx, producer);

			registerASGElement(result);
		} else if (ctx.tableCall() != null) {
			final Call tableCall = createCall(ctx.tableCall());
			result = new CallDelegateImpl(tableCall, programUnit, ctx, producer);

			registerASGElement(result);
		} else if (ctx.functionCall() != null) {
			final Call functionCall = createCall(ctx.functionCall());
			result = new CallDelegateImpl(functionCall, programUnit, ctx, producer);

			registerASGElement(result);
		} else if (ctx.specialRegister() != null) {
			final Call specialRegisterCall = createCall(ctx.specialRegister());
			result = new CallDelegateImpl(specialRegisterCall, programUnit, ctx, producer);
	...
	protected Call createCall(final MnemonicNameContext ctx) {
		...
		if (result == null) {
			final String name = determineName(ctx);
			result = new MnemonicCallImpl(name, programUnit, ctx, producer);
	...
	protected Call createCall(final ParserRuleContext... ctxs) {
		...
		for (final ParserRuleContext ctx : ctxs) {
			...
			if (ctx instanceof IdentifierContext) {
				...
				producer.emitWarningMessage("unknown call at " + ctx);
			}
		}
	...
	protected Call createCall(final QualifiedDataNameFormat2Context ctx) {
		...
		if (section == null) {
			...
			if (paragraph == null) {
				...
				result = new ProcedureCallImpl(paragraphName, paragraph, programUnit, ctx, producer);
			}
		}
	...
	protected Call createCall(final SpecialRegisterContext ctx) {
		...
		if (result == null) {
			...
			result = new SpecialRegisterCallImpl(type, programUnit, ctx, producer);
	...
	protected Call createCall(final TableCallContext ctx) {
		...
		if (result == null) {
			...
			if (dataDescriptionEntries.isEmpty()) {
				...
				final TableCall tableCall = new TableCallImpl(name, dataDescriptionEntry, programUnit, ctx, producer);
	...
	protected CallValueStmt createCallValueStmt(final AlphabetNameContext ctx) {
		...
		final CallValueStmt result = new CallValueStmtImpl(delegatedCall, programUnit, ctx, producer);
		return result;
	}
	...
	protected CommunicationDescriptionEntryCall createCommunicationDescriptionEntryCall(final String name,
		...
		if (result == null) {
			result = new CommunicationDescriptionEntryCallImpl(name, communicationDescriptionEntry, programUnit, ctx, producer);
	...
	protected ConditionValueStmt createConditionValueStmt(final ConditionContext ctx) {
		...
		if (result == null) {
			result = new ConditionValueStmtImpl(programUnit, ctx, producer);
	...
	protected DataDescriptionEntryCall createDataDescriptionEntryCall(final String name,
		...
		if (result == null) {
			result = new DataDescriptionEntryCallImpl(name, dataDescriptionEntry, programUnit, ctx, producer);
	...
	protected FigurativeConstant createFigurativeConstant(final FigurativeConstantContext ctx) {
		...
		if (result == null) {
			...
			result = new FigurativeConstantImpl(type, programUnit, ctx, producer);
	...
	protected FileControlEntryCall createFileControlEntryCall(final String name,
		...
		if (result == null) {
			result = new FileControlEntryCallImpl(name, fileControlEntry, programUnit, ctx, producer);
	...
	protected IndexCall createIndexCall(final ParserRuleContext ctx) {
		...
		if (result == null) {
			...
			if (index == null) {
				...
				result = new IndexCallImpl(name, index, programUnit, ctx, producer);
	...
	protected IntegerLiteral createIntegerLiteral(final IntegerLiteralContext ctx) {
		...
		if (result == null) {
			...
			result = new IntegerLiteralImpl(value, programUnit, ctx, producer);
	...
	protected IntegerLiteralValueStmt createIntegerLiteralValueStmt(final IntegerLiteralContext ctx) {
		...
		final IntegerLiteralValueStmt result = new IntegerLiteralValueStmtImpl(programUnit, ctx, producer);
	...
	protected Literal createLiteral(final LiteralContext ctx) {
		...
		if (result == null) {
			result = new LiteralImpl(programUnit, ctx, producer);
	...
	protected LiteralValueStmt createLiteralValueStmt(final LiteralContext ctx) {
		...
		final LiteralValueStmt result = new LiteralValueStmtImpl(programUnit, ctx, producer);
		result.setLiteral(literal);
		return result;
	}
	...
	protected MnemonicName createMnemonicName(final MnemonicNameContext ctx) {
		...
		if (result == null) {
			...
			result = new MnemonicNameImpl(value, programUnit, ctx, producer);
	...
	protected NumericLiteral createNumericLiteral(final NumericLiteralContext ctx) {
		...
		if (result == null) {
			result = new NumericLiteralImpl(programUnit, ctx, producer);
	...
	protected ProcedureCall createProcedureCall(final String name, final Paragraph paragraph,
		...
		if (result == null) {
			result = new ProcedureCallImpl(name, paragraph, programUnit, ctx, producer);
	...
	protected RelationConditionValueStmt createRelationConditionValueStmt(final RelationConditionContext ctx) {
		...
		if (result == null) {
			result = new RelationConditionValueStmtImpl(programUnit, ctx, producer);
	...
	protected ReportCall createReportCall(final String name, final ReportDescription report,
		...
		if (result == null) {
			result = new ReportCallImpl(name, report, programUnit, ctx, producer);
	...
	protected ReportDescriptionEntryCall createReportDescriptionEntryCall(final String name,
		...
		if (result == null) {
			result = new ReportDescriptionEntryCallImpl(name, reportDescriptionEntry, programUnit, ctx, producer);
	...
	protected Call createSectionCall(final String name, final Section section, final ProcedureNameContext ctx) {
		...
		if (result == null) {
			result = new SectionCallImpl(name, section, programUnit, ctx, producer);
	...
	protected Call createUndefinedCall(final ParserRuleContext ctx) {
		...
		if (result == null) {
			final String name = determineName(ctx);
			result = new UndefinedCallImpl(name, programUnit, ctx, producer);
	...
	protected ValueStmt createValueStmt(final ParserRuleContext... ctxs) {
		...
		for (final ParserRuleContext ctx : ctxs) {
			...
			if (ctx instanceof IdentifierContext) {
				...
				producer.emitWarningMessage("unknown value stmt at " + ctx);
			}
		}
