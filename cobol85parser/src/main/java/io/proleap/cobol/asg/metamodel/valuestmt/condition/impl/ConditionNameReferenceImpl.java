...
public class ConditionNameReferenceImpl extends ValueStmtImpl implements ConditionNameReference {
	...
	public ConditionNameReferenceImpl(final ProgramUnit programUnit, final ConditionNameReferenceContext ctx, final Producer producer) {
	...
	public InData addInData(final InDataContext ctx) {
		...
		if (result == null) {
			result = new InDataImpl(programUnit, ctx, producer);
	...
	public InFile addInFile(final InFileContext ctx) {
		...
		if (result == null) {
			result = new InFileImpl(programUnit, ctx, producer);
	...
	public InMnemonic addInMnemonic(final InMnemonicContext ctx) {
		...
		if (result == null) {
			result = new InMnemonicImpl(programUnit, ctx, producer);
	...
	public ConditionNameSubscriptReference addSubscriptReference(final ConditionNameSubscriptReferenceContext ctx) {
		...
		if (result == null) {
			result = new ConditionNameSubscriptReferenceImpl(programUnit, ctx, producer);
