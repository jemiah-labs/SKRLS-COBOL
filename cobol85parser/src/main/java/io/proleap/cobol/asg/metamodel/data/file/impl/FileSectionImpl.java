...
public class FileSectionImpl extends CobolDivisionElementImpl implements FileSection {
	...
	public FileSectionImpl(final ProgramUnit programUnit, final FileSectionContext ctx, final Producer producer) {
	...
	public FileDescriptionEntry addFileDescriptionEntry(final FileDescriptionEntryContext ctx) {
		...
		if (result == null) {
			...
			result = new FileDescriptionEntryImpl(name, programUnit, ctx, producer);
