...
public class ComputeStatementImpl extends StatementImpl implements ComputeStatement {
	...
	public ComputeStatementImpl(final ProgramUnit programUnit, final Scope scope, final ComputeStatementContext ctx, final Producer producer) {
	...
	public Store addStore(final ComputeStoreContext ctx) {
		...
		if (result == null) {
			result = new StoreImpl(programUnit, ctx, producer);
