...
public class UseAfterStatementImpl extends CobolDivisionElementImpl implements UseAfterStatement {
	...
	public UseAfterStatementImpl(final ProgramUnit programUnit, final UseAfterClauseContext ctx, final Producer producer) {
	...
	public AfterOn addAfterOn(final UseAfterOnContext ctx) {
		...
		if (result == null) {
			result = new AfterOnImpl(programUnit, ctx, producer);
