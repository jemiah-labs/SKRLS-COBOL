...
public class SetStatementImpl extends StatementImpl implements SetStatement {
	...
	public SetStatementImpl(final ProgramUnit programUnit, final Scope scope, final SetStatementContext ctx, final Producer producer) {
	...
	public SetBy addSetBy(final SetUpDownByStatementContext ctx) {
		...
		if (result == null) {
			result = new SetByImpl(programUnit, ctx, producer);
	...
	public SetTo addSetTo(final SetToStatementContext ctx) {
		...
		if (result == null) {
			result = new SetToImpl(programUnit, ctx, producer);
