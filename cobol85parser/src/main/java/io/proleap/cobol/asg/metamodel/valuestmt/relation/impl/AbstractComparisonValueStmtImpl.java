...
public abstract class AbstractComparisonValueStmtImpl extends ValueStmtImpl implements ComparisonStmt {
	...
	public AbstractComparisonValueStmtImpl(final ProgramUnit programUnit, final ParserRuleContext ctx, final Producer producer) {
	...
	public RelationalOperator addOperator(final RelationalOperatorContext ctx) {
		...
		if (result == null) {
			result = new RelationalOperatorImpl(programUnit, ctx, producer);
