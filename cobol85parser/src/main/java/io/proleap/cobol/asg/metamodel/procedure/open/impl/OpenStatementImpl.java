...
public class OpenStatementImpl extends StatementImpl implements OpenStatement {
	...
	public OpenStatementImpl(final ProgramUnit programUnit, final Scope scope, final OpenStatementContext ctx, final Producer producer) {
	...
	public ExtendPhrase addExtendPhrase(final OpenExtendStatementContext ctx) {
		...
		if (result == null) {
			result = new ExtendPhraseImpl(programUnit, ctx, producer);
	...
	public InputOutputPhrase addInputOutputPhrase(final OpenIOStatementContext ctx) {
		...
		if (result == null) {
			result = new InputOutputPhraseImpl(programUnit, ctx, producer);
	...
	public InputPhrase addInputPhrase(final OpenInputStatementContext ctx) {
		...
		if (result == null) {
			result = new InputPhraseImpl(programUnit, ctx, producer);
	...
	public OutputPhrase addOutputPhrase(final OpenOutputStatementContext ctx) {
		...
		if (result == null) {
			result = new OutputPhraseImpl(programUnit, ctx, producer);
