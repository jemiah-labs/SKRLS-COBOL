...
public class ReplacingAllLeadingsImpl extends InspectPhraseImpl implements ReplacingAllLeadings {
	...
	public ReplacingAllLeadingsImpl(final ProgramUnit programUnit, final InspectReplacingAllLeadingsContext ctx, final Producer producer) {
	...
	public ReplacingAllLeading addAllLeading(final InspectReplacingAllLeadingContext ctx) {
		...
		if (result == null) {
			result = new ReplacingAllLeadingImpl(programUnit, ctx, producer);
