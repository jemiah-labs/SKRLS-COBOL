...
public class CollatingSequenceImpl extends CobolDivisionElementImpl implements CollatingSequencePhrase {
	...
	public CollatingSequenceImpl(final ProgramUnit programUnit, final MergeCollatingSequencePhraseContext ctx, final Producer producer) {
	...
	public Alphanumeric addAlphanumeric(final MergeCollatingAlphanumericContext ctx) {
		...
		if (result == null) {
			result = new AlphanumericImpl(programUnit, ctx, producer);
	...
	public National addNational(final MergeCollatingNationalContext ctx) {
		...
		if (result == null) {
			result = new NationalImpl(programUnit, ctx, producer);
