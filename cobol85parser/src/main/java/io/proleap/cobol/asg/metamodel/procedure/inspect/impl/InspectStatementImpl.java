...
public class InspectStatementImpl extends StatementImpl implements InspectStatement {
	...
	public InspectStatementImpl(final ProgramUnit programUnit, final Scope scope, final InspectStatementContext ctx, final Producer producer) {
	...
	public Converting addConverting(final InspectConvertingPhraseContext ctx) {
		...
		if (result == null) {
			result = new ConvertingImpl(programUnit, ctx, producer);
	...
	public Tallying addTallying(final InspectTallyingPhraseContext ctx) {
		...
		if (result == null) {
			result = new TallyingImpl(programUnit, ctx, producer);
	...
	public TallyingReplacing addTallyingReplacing(final InspectTallyingReplacingPhraseContext ctx) {
		...
		if (result == null) {
			result = new TallyingReplacingImpl(programUnit, ctx, producer);
