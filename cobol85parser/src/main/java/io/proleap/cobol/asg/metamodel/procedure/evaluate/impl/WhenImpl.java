...
public class WhenImpl extends CobolDivisionElementImpl implements When {
	...
	public WhenImpl(final ProgramUnit programUnit, final EvaluateWhenContext ctx, final Producer producer) {
	...
	public AlsoCondition addAlsoCondition(final EvaluateAlsoConditionContext ctx) {
		...
		if (result == null) {
			result = new AlsoConditionImpl(programUnit, ctx, producer);
	...
	public Condition addCondition(final EvaluateConditionContext ctx) {
		...
		if (result == null) {
			result = new ConditionImpl(programUnit, ctx, producer);
