...
public class AddStatementImpl extends StatementImpl implements AddStatement {
	...
	public AddStatementImpl(final ProgramUnit programUnit, final Scope scope, final AddStatementContext ctx, final Producer producer) {
	...
	public AddCorrespondingStatement addAddCorrespondingStatement(final AddCorrespondingStatementContext ctx) {
		...
		if (result == null) {
			result = new AddCorrespondingStatementImpl(programUnit, ctx, producer);
	...
	public AddToGivingStatement addAddToGivingStatement(final AddToGivingStatementContext ctx) {
		...
		if (result == null) {
			result = new AddToGivingStatementImpl(programUnit, ctx, producer);
	...
	public AddToStatement addAddToStatement(final AddToStatementContext ctx) {
		...
		if (result == null) {
			result = new AddToStatementImpl(programUnit, ctx, producer);
	...
	protected ToGiving createToGiving(final AddToGivingContext ctx) {
		...
		if (result == null) {
			result = new ToGivingImpl(programUnit, ctx, producer);
