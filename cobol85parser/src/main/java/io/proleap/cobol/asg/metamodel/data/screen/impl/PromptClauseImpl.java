...
public class PromptClauseImpl extends CobolDivisionElementImpl implements PromptClause {
	...
	public PromptClauseImpl(final ProgramUnit programUnit, final ScreenDescriptionPromptClauseContext ctx, final Producer producer) {
	...
	public Occurs addOccurs(final ScreenDescriptionPromptOccursClauseContext ctx) {
		...
		if (result == null) {
			result = new OccursImpl(programUnit, ctx, producer);
