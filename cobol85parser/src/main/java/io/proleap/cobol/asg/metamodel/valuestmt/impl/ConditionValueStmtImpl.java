...
public class ConditionValueStmtImpl extends ValueStmtImpl implements ConditionValueStmt {
	...
	public ConditionValueStmtImpl(final ProgramUnit programUnit, final ConditionContext ctx, final Producer producer) {
	...
	public AndOrCondition addAndOrCondition(final AndOrConditionContext ctx) {
		...
		if (result == null) {
			result = new AndOrConditionImpl(programUnit, ctx, producer);
	...
	public CombinableCondition addCombinableCondition(final CombinableConditionContext ctx) {
		...
		if (result == null) {
			result = new CombinableConditionImpl(programUnit, ctx, producer);
