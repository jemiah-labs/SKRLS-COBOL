...
public class ReportSectionImpl extends CobolDivisionElementImpl implements ReportSection {
	...
	public ReportSectionImpl(final ProgramUnit programUnit, final ReportSectionContext ctx, final Producer producer) {
	...
	public ReportDescription addReportDescription(final ReportDescriptionContext ctx) {
		...
		if (result == null) {
			...
			result = new ReportDescriptionImpl(name, programUnit, ctx, producer);
