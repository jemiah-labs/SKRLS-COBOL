...
public class ReplacingImpl extends InspectPhraseImpl implements Replacing {
	...
	public ReplacingImpl(final ProgramUnit programUnit, final InspectReplacingPhraseContext ctx, final Producer producer) {
	...
	public ReplacingAllLeadings addAllLeadings(final InspectReplacingAllLeadingsContext ctx) {
		...
		if (result == null) {
			result = new ReplacingAllLeadingsImpl(programUnit, ctx, producer);
	...
	public ReplacingCharacters addCharacters(final InspectReplacingCharactersContext ctx) {
		...
		if (result == null) {
			result = new ReplacingCharactersImpl(programUnit, ctx, producer);
