...
public class ReceiveFromStatementImpl extends CobolDivisionElementImpl implements ReceiveFromStatement {
	...
	public ReceiveFromStatementImpl(final ProgramUnit programUnit, final ReceiveFromStatementContext ctx, final Producer producer) {
	...
	public Before addBefore(final ReceiveBeforeContext ctx) {
		...
		if (result == null) {
			result = new BeforeImpl(programUnit, ctx, producer);
	...
	public Size addSize(final ReceiveSizeContext ctx) {
		...
		if (result == null) {
			result = new SizeImpl(programUnit, ctx, producer);
	...
	public Status addStatus(final ReceiveStatusContext ctx) {
		...
		if (result == null) {
			result = new StatusImpl(programUnit, ctx, producer);
	...
	public Thread addThread(final ReceiveThreadContext ctx) {
		...
		if (result == null) {
			result = new ThreadImpl(programUnit, ctx, producer);
