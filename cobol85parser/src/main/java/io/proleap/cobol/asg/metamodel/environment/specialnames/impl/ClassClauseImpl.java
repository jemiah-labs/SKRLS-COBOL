...
public class ClassClauseImpl extends CobolDivisionElementImpl implements ClassClause {
	...
	public ClassClauseImpl(final ProgramUnit programUnit, final ClassClauseContext ctx, final Producer producer) {
	...
	public ClassThrough addClassThrough(final ClassClauseThroughContext ctx) {
		...
		if (result == null) {
			result = new ClassThroughImpl(programUnit, ctx, producer);
