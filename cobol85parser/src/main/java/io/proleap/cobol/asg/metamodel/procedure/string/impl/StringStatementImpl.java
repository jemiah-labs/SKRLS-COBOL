...
public class StringStatementImpl extends StatementImpl implements StringStatement {
	...
	public StringStatementImpl(final ProgramUnit programUnit, final Scope scope, final StringStatementContext ctx, final Producer producer) {
	...
	public Sendings addSendings(final StringSendingPhraseContext ctx) {
		...
		if (result == null) {
			result = new SendingsImpl(programUnit, ctx, producer);
