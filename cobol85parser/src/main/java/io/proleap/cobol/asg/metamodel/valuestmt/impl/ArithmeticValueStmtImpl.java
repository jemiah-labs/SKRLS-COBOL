...
public class ArithmeticValueStmtImpl extends ValueStmtImpl implements ArithmeticValueStmt {
	...
	public ArithmeticValueStmtImpl(final ProgramUnit programUnit, final ArithmeticExpressionContext ctx, final Producer producer) {
	...
	public MultDivs addMultDivs(final MultDivsContext ctx) {
		...
		if (result == null) {
			result = new MultDivsImpl(programUnit, ctx, producer);
	...
	public PlusMinus addPlusMinus(final PlusMinusContext ctx) {
		...
		if (result == null) {
			result = new PlusMinusImpl(programUnit, ctx, producer);
