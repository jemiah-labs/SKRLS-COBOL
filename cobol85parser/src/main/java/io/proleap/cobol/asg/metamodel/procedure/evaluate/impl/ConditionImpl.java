...
public class ConditionImpl extends CobolDivisionElementImpl implements Condition {
	...
	public ConditionImpl(final ProgramUnit programUnit, final EvaluateConditionContext ctx, final Producer producer) {
	...
	public Through addThrough(final EvaluateThroughContext ctx) {
		...
		if (result == null) {
			result = new ThroughImpl(programUnit, ctx, producer);
	...
	public Value addValue(final EvaluateValueContext ctx) {
		...
		if (result == null) {
			result = new ValueImpl(programUnit, ctx, producer);
