...
public class GoToStatementImpl extends StatementImpl implements GoToStatement {
	...
	public GoToStatementImpl(final ProgramUnit programUnit, final Scope scope, final GoToStatementContext ctx, final Producer producer) {
	...
	public DependingOnPhrase addDependingOnPhrase(final GoToDependingOnStatementContext ctx) {
		...
		if (result == null) {
			result = new DependingOnPhraseImpl(programUnit, ctx, producer);
	...
	public Simple addSimple(final GoToStatementSimpleContext ctx) {
		...
		if (result == null) {
			result = new SimpleImpl(programUnit, ctx, producer);
