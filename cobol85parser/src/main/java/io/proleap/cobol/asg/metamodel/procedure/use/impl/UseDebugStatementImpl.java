...
public class UseDebugStatementImpl extends CobolDivisionElementImpl implements UseDebugStatement {
	...
	public UseDebugStatementImpl(final ProgramUnit programUnit, final UseDebugClauseContext ctx, final Producer producer) {
	...
	public DebugOn addDebugOn(final UseDebugOnContext ctx) {
		...
		if (result == null) {
			result = new DebugOnImpl(programUnit, ctx, producer);
