...
public class ReceiveStatementImpl extends StatementImpl implements ReceiveStatement {
	...
	public ReceiveStatementImpl(final ProgramUnit programUnit, final Scope scope, final ReceiveStatementContext ctx, final Producer producer) {
	...
	public ReceiveFromStatement addReceiveFromStatement(final ReceiveFromStatementContext ctx) {
		...
		if (result == null) {
			result = new ReceiveFromStatementImpl(programUnit, ctx, producer);
	...
	public ReceiveIntoStatement addReceiveIntoStatement(final ReceiveIntoStatementContext ctx) {
		...
		if (result == null) {
			result = new ReceiveIntoStatementImpl(programUnit, ctx, producer);
