...
public class ReceiveIntoStatementImpl extends CobolDivisionElementImpl implements ReceiveIntoStatement {
	...
	public ReceiveIntoStatementImpl(final ProgramUnit programUnit, final ReceiveIntoStatementContext ctx, final Producer producer) {
	...
	public NoData addNoData(final ReceiveNoDataContext ctx) {
		...
		if (result == null) {
			result = new NoDataImpl(programUnit, ctx, producer);
	...
	public WithData addWithData(final ReceiveWithDataContext ctx) {
		...
		if (result == null) {
			result = new WithDataImpl(programUnit, ctx, producer);
