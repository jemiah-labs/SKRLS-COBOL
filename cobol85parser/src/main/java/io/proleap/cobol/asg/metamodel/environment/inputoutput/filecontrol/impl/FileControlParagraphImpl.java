...
public class FileControlParagraphImpl extends CobolDivisionElementImpl implements FileControlParagraph {
	...
	public FileControlParagraphImpl(final ProgramUnit programUnit, final FileControlParagraphContext ctx, final Producer producer) {
	...
	public FileControlEntry addFileControlEntry(final FileControlEntryContext ctx) {
		...
		if (result == null) {
			...
			result = new FileControlEntryImpl(name, programUnit, ctx, producer);
