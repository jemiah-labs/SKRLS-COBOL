...
public class SimpleConditionImpl extends ValueStmtImpl implements SimpleCondition {
	...
	public SimpleConditionImpl(final ProgramUnit programUnit, final SimpleConditionContext ctx, final Producer producer) {
	...
	public ClassCondition addClassCondition(final ClassConditionContext ctx) {
		...
		if (result == null) {
			result = new ClassConditionImpl(programUnit, ctx, producer);
	...
	public ConditionNameReference addConditionNameReference(final ConditionNameReferenceContext ctx) {
		...
		if (result == null) {
			result = new ConditionNameReferenceImpl(programUnit, ctx, producer);
