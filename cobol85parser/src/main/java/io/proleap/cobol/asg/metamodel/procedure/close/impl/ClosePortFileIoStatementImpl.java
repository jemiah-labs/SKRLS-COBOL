...
public class ClosePortFileIoStatementImpl extends CobolDivisionElementImpl implements ClosePortFileIoStatement {
	...
	public ClosePortFileIoStatementImpl(final ProgramUnit programUnit, final ClosePortFileIOStatementContext ctx, final Producer producer) {
	...
	public Using addUsing(final ClosePortFileIOUsingContext ctx) {
		...
		if (result == null) {
			result = new UsingImpl(programUnit, ctx, producer);
