...
public class ForImpl extends InspectPhraseImpl implements For {
	...
	public ForImpl(final ProgramUnit programUnit, final InspectForContext ctx, final Producer producer) {
	...
	public AllLeadingPhrase addAllLeadingPhrase(final InspectAllLeadingsContext ctx) {
		...
		if (result == null) {
			result = new AllLeadingPhraseImpl(programUnit, ctx, producer);
	...
	public Characters addCharacters(final InspectCharactersContext ctx) {
		...
		if (result == null) {
			result = new CharactersImpl(programUnit, ctx, producer);
