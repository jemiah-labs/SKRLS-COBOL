...
public class OutputPhraseImpl extends CobolDivisionElementImpl implements OutputPhrase {
	...
	public OutputPhraseImpl(final ProgramUnit programUnit, final OpenOutputStatementContext ctx, final Producer producer) {
	...
	public Output addOpenOutput(final OpenOutputContext ctx) {
		...
		if (result == null) {
			result = new OutputImpl(programUnit, ctx, producer);
