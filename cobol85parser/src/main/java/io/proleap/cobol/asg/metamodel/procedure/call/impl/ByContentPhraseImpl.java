...
public class ByContentPhraseImpl extends CobolDivisionElementImpl implements ByContentPhrase {
	...
	public ByContentPhraseImpl(final ProgramUnit programUnit, final CallByContentPhraseContext ctx, final Producer producer) {
	...
	public ByContent addByContent(final CallByContentContext ctx) {
		...
		if (result == null) {
			result = new ByContentImpl(programUnit, ctx, producer);
