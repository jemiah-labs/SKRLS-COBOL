...
public class VaryingClauseImpl extends CobolDivisionElementImpl implements VaryingClause {
	...
	public VaryingClauseImpl(final ProgramUnit programUnit, final PerformVaryingClauseContext ctx, final Producer producer) {
	...
	public After addAfter(final PerformAfterContext ctx) {
		...
		if (result == null) {
			result = new AfterImpl(programUnit, ctx, producer);
