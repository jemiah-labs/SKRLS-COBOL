...
public class CancelStatementImpl extends StatementImpl implements CancelStatement {
	...
	public CancelStatementImpl(final ProgramUnit programUnit, final Scope scope, final CancelStatementContext ctx, final Producer producer) {
	...
	public CancelCall addCancelCall(final CancelCallContext ctx) {
		...
		if (result == null) {
			result = new CancelCallImpl(programUnit, ctx, producer);
