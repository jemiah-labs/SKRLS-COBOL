...
public class StopStatementImpl extends StatementImpl implements StopStatement {
	...
	public StopStatementImpl(final ProgramUnit programUnit, final Scope scope, final StopStatementContext ctx, final Producer producer) {
	...
	public StopStatementGiving addStopStatementGiving(final StopStatementGivingContext ctx) {
		...
		if (result == null) {
			result = new StopStatementGivingImpl(programUnit, ctx, producer);
